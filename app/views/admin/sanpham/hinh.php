    ...
    <div class="content-page card-box">
        ...
        <div class="alert alert-success title_page" role="alert">
            <div class="row">
                ...
                <div class="col-6">
                    <form class="d-flex" action="<?php echo BASE_URL ?>sanpham/hinh_timkiem" method="POST">
          ...
          foreach ($data['hinh'] as $key => $h) {
            ...
            ?>
                <tr>
                    ...
                    <td style="width: 30%;">
                        <img style="width: 30%;"
                            src="<?php echo BASE_URL ?>public/uploads/hinh_chitiet/<?php echo $h['hinh'] ?>" alt="">
                    </td>
                    <td style="width: 20%;">
          ...
          if($level == 1){
            ?>
                <a onclick="return confirm('Bạn có muốn xóa tất cả không?')"
                    href="<?php echo BASE_URL ?>sanpham/hinh_deleteAll">
