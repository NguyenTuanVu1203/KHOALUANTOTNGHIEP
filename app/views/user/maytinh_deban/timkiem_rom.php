<div class="list_sanpham mt-4 container">
    ...
    if($data['sanpham_ma_dm_rom']){
      ...
      ?>
    <p class="text-success" style="font-weight: bold;">Có <b style="color: #ff6407;"><?php echo $i ?></b> sản phẩm BỘ
        NHỚ TRONG <b style="color: #ff6407;"><?php echo  $sp['rom'].' GB' ?></b> đuợc tìm thấy
    </p>
    <?php
    }else{
