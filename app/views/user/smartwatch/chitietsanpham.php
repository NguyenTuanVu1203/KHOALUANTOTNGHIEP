      ...
      foreach($data['sanpham_ma'] as $key => $sp){
        ...
        <div class="verticals ten offset-by-one">
            <ol class="breadcrumb breadcrumb-fill2 style2">
                ...
                <li class="fw-bold"><a
                        href="<?php echo BASE_URL ?><?php echo $sp['ghichu_dm'] ?>/sanpham/11"><?php echo $sp['ten_dm'] ?></a>
                </li>
    ...
    <div class="row">
      ...
      foreach ($data['sanpham_tuongtu'] as $key => $sp){
        ...
        <div class="sanpham_item col-xs-12 col-sm-6 col-md-2 mt-5 img-hover-zoom img-hover-zoom--brightness">
            <a
                href="<?php echo BASE_URL ?>smartwatch/chitiet_sanpham/<?php echo $sp['ma_sp'] ?>/<?php echo $sp['ma_th'] ?>/<?php echo $sp['ma_dm'] ?>">
