        ...
        <div class="col-2">
            <div class="btn-group ">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a class="dropdown-item" href="<?php echo BASE_URL ?>table/timkiem_gia/2/4">Từ 2 triệu - 4
                            triệu</a>
                    </li>
                    <li>
                        <hr class="dropdown-divider">
                    ...
                    <li>
                        <a class="dropdown-item" href="<?php echo BASE_URL ?>table/timkiem_gia/4/7">Từ 4 triệu - 7
                            triệu</a>
                    </li>
                    <li>
                        <hr class="dropdown-divider">
                    ...
                    <li>
                        <a class="dropdown-item" href="<?php echo BASE_URL ?>table/timkiem_gia/7/13">Từ 7 triệu - 13
                            triệu</a>
                    </li>
                    <li>
                        <hr class="dropdown-divider">
                    ...
                    <li>
                        <a class="dropdown-item" href="<?php echo BASE_URL ?>table/timkiem_gia/13/20">Từ 13 triệu - 20
                            triệu</a>
                    </li>
                    <li>
                        <hr class="dropdown-divider">
    ...
    <div class="row mb-4 timkiem_hang ">
      ...
      foreach ($data['thuonghieu_ma_dm'] as $key => $dmth){
        ...
        <div class="col-2 p-3 p-3 btn_hang">
            <a
                href="<?php echo BASE_URL ?>table/timkiem_thuonghieu/<?php echo $dmth['ma_dm'] ?>/<?php echo $dmth['ma_th'] ?>">
