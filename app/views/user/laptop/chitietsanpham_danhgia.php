              ...
              if($data['khuyenmai']){
                ?>
                        <div class="title khuyenmai_title" style="font-weight: bold; color: #E51F22; font-size: 20px;">
                            <i class="fa-solid fa-gift" style="font-size:25px ;"></i> &ensp;Khuyến mãi
                        </div>
                        <?php
                    ...
                    <div class="row">
                      ...
                      foreach ($data['donhang'] as $key => $dh){
                        ?>
                            ...
                            <input type="text" name="ten_k" class="form-control" required minlength="5"
                                value="<?php echo $dh['ten_k'] ?>">
                            <?php
                      }
                    ?>
                            ...
                            <button type="submit" class="btn btn-primary mt-3 float-end"
                                style="background-color: #16511a;"> <i
