<div class="container mb-4">
      ...
      foreach($data['sanpham_ma'] as $key => $sp){
        ...
        <div class="verticals ten offset-by-one">
            <ol class="breadcrumb breadcrumb-fill2 style2">
                ...
                <li class="fw-bold"><a
                        href="<?php echo BASE_URL ?><?php echo $sp['ghichu_dm'] ?>/sanpham/9"><?php echo $sp['ten_dm'] ?></a>
                </li>
    ...
    <div class="row mt-3">
            ...
            foreach($data['hinh_limit1'] as $key => $h){
              ?>
                    <div class="carousel-item active" data-bs-interval="1000">
                        <img src="<?php echo BASE_URL ?>public/uploads/hinh_chitiet/<?php echo $h['hinh'] ?>"
            ...
            <div class="row mt-4">
                <div class="col-6">
                    <div class="row">
                        ...
                        <div class="col-11">
                            <p class="ps-4">Hư gì đổi nấy <b>12</b> tháng tại 3192 siêu thị toàn quốc (miễn phí tháng
                                đầu)</p>
                        </div>
                    </div>
                    <div class="row">
        ...
        foreach($data['sanpham_ma'] as $key => $sp){
          ?>
            <div>
                <img src="<?php echo BASE_URL ?>public/uploads/sanpham/<?php echo $sp['hinhchitiet_sp'] ?>" alt=""
                    class="d-block w-100">
            </div>
            <?php
        }
      ?>
            <div class="khuyenmai">
              ...
              if($data['khuyenmai']){
                ?>
                        <div class="title khuyenmai_title" style="font-weight: bold; color: #E51F22; font-size: 20px;">
                            <i class="fa-solid fa-gift" style="font-size:25px ;"></i> &ensp;Khuyến mãi</div>
                        <?php
                        ...
                        <label class="plan basic-plan" for="1">
                            ...
                            <div class="plan-content">
                                ...
                                <div class="plan-details">
                                    ...
                                    <p>Đơn tối thiểu
                                        <?php echo number_format($km['dieukien_km'], 0, ',', '.') . ' <sup>đ</sup>'.' được giảm '?><?php echo $km['phantram_km'].'%' ?>
                                    </p>
                                </div>
                            </div>
                        </label>
          ...
          ?>
            <div class="chitiet_sanpham_gia">
                <div class="alert alert-danger" role="alert"
                    style="background-color:#FEE2E2 ; color: red; font-weight: bold; font-size: 20px;">
                    <i class="fa-solid fa-circle-dollar-to-slot"></i> &ensp;
                    <?php echo number_format($sp['gia_sp'], 0, ',', '.') . ' <sup>đ</sup>'  ?>
                    <span
                        style="color: gray; text-decoration: line-through;"><?php echo number_format($sp['gia_sp']+200000, 0, ',', '.') . ' <sup>đ</sup>'  ?></span>
                    <p style="font-size:15px ; color: gray;">Số lượng sản phẩm còn lại: <?php echo $sp['soluong_sp'] ?>
                    </p>
                </div>
            </div>
            <div class="mota">
                ...
                <button type="button" class="btn btn-success" style="background-color:#16511a ;">
                    <span
                        style="border-radius: 50%; background-color: <?php echo $msp['mau'] ?>; color: <?php echo $msp['mau'] ?>;">...
                    </span> &ensp;
                    <?php echo $msp['ten_m'] ?>
                </button>
                <?php
                            ...
                            <table class="table table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $sp['thoidiem_ramat'] ?></td>
                                    </tr>
                                </tbody>
                            </table>
                            </p>
            ...
            <div class="chonmau">
                <form action="<?php echo BASE_URL ?>giohang/giohang_insert" method="POST">
                    ...
                    <div class="">
                        <div class="">
                            ...
                            foreach ($data['mau_sanpham_ma'] as $key => $msp){
                              $i++;
                              ?>
                                    <option class="select__item" value="<?php echo $msp['ma_m'] ?>">
                                        <?php echo $msp['ten_m'] ?></option>
                    ...
                    if ($sp['soluong_sp'] > 0){
                      ?>
                        <button
                            onclick="return confirm('Sản phẩm <?php echo $sp['ten_sp'] ?> được thêm thành công !!!')"
                            class="btn btn-light p-4" type="submit"
                            style="background-color:#E51F22 ; color: white; font-size: 18px; font-weight: bold;">Thêm
                            vào giỏ hàng</button>
                        <?php
                    }else{
                      ?>
                        <button type="button" class="btn"
                            style="padding: 15px; background-color: #497174; color: white; font-weight: bold;">Sản phẩm
                            hết hàng</button>
                        <?php
                    }
                  ?>
            ...
            ?>
                <div class="mt-3 mb-3">
                    <a href="<?php echo BASE_URL ?>index/chitiet_tintuc/<?php echo $tt['ma_tt'] ?>"
                        ...
                        <div class="row">
                            <div class="col-3">
                                <img src="<?php echo BASE_URL ?>public/uploads/tintuc/<?php echo $tt['hinh_tt'] ?>"
                                    class="d-block w-100">
                            </div>
                            <div class="col-9">
        ...
        <div class="thongtin_sanpham">
            <div class="">
                ...
                <div class="alert alert-warning" role="alert"
                    style="font-weight: bold; font-size: 20px; text-align: center; color: white; background-color: #E6A157;">
                    THÔNG TIN SẢN PHẨM
                </div>
                <div class="row py-5 justify-content-center">
                    <div class="col-md-12">
              ...
              foreach($data['sanpham_ma'] as $key => $sp){
                ?>
                        <div class="scrollspy-example" data-bs-spy="scroll" data-bs-target="#lex" id="work"
                            data-offset="20" style="height: 400px; overflow: auto;">
                            <p>
                ...
                if($data['danhgia_ma_sp']){
                  ...
                  ?>
                        <p class="text-center" style="margin-top: 30%;">
                            <span style="color:#FE8C23 ; font-weight: bold; font-size: 30px;"><?php echo $tb ?> &ensp;
                            </span>
                            <?php
                          for($i = 1; $i<=$tb; $i++){
                            ?>
                            <i class="fa-solid fa-star" style="color: #FE8C23; font-size: 30px;"></i>
                            <?php
                          }
                          if($tb<5){
                            for($i = 1; $i<=5-$tb; $i++){
                ...
                ?>
                            ...
                            <div class="col-7">
                                <div class="progress">
                                    <div class="progress-bar bg-warning" role="progressbar" aria-label="Warning example"
                                        style="width: <?php echo ($sao_5/$so_danhgia)*100 .'%' ?>;" aria-valuenow="75"
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="progress">
                                    <div class="progress-bar bg-warning" role="progressbar" aria-label="Warning example"
                                        style="width: <?php echo ($sao_4/$so_danhgia)*100 .'%' ?>;" aria-valuenow="75"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="col-4" style="color: blue; font-weight: bold;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="progress">
                                    <div class="progress-bar bg-warning" role="progressbar" aria-label="Warning example"
                                        style="width: <?php echo ($sao_3/$so_danhgia)*100 .'%' ?>;" aria-valuenow="75"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="col-4" style="color: blue; font-weight: bold;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="progress">
                                    <div class="progress-bar bg-danger" role="progressbar" aria-label="Warning example"
                                        style="width: <?php echo ($sao_2/$so_danhgia)*100 .'%' ?>;" aria-valuenow="75"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="col-4" style="color: blue; font-weight: bold;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="progress">
                                    <div class="progress-bar bg-danger" role="progressbar" aria-label="Warning example"
                                        style="width: <?php echo ($sao_1/$so_danhgia)*100 .'%' ?>;" aria-valuenow="75"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="col-4" style="color: blue; font-weight: bold;">
                ...
                ?>
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="progress">
                                    <div class="progress-bar bg-warning" role="progressbar" aria-label="Warning example"
                                        style="width: 0%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                                    </div>
                                </div>
                            </div>
                            <div class="col-4" style="color: blue; font-weight: bold;">
    ...
    <div class="row sanpham_tuongtu">
        <div class="alert alert-info" role="alert"
            style="text-align:center ; font-weight:bold ; font-size: 20px; color: #16511a;">
            Sản phẩm tương tự
        </div>
        <?php
      foreach ($data['sanpham_tuongtu'] as $key => $sp){
        ...
        <div class="sanpham_item col-xs-12 col-sm-6 col-md-2 mt-5 img-hover-zoom img-hover-zoom--brightness">
            <a
                href="<?php echo BASE_URL ?>dienthoai/chitiet_sanpham/<?php echo $sp['ma_sp'] ?>/<?php echo $sp['ma_th'] ?>/<?php echo $sp['ma_dm'] ?>">
                <img src="<?php echo BASE_URL ?>public/uploads/sanpham/<?php echo $sp['hinh_sp'] ?>"
                    class="d-block w-100">
            </a>
            ...
            <div class="row tex-center ms-2">
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="col-2">
                    <span
                        style="border-radius:100% ; background-color: <?php echo $row['mau'] ?> ; color: <?php echo $row['mau'] ?>;">....</span>
                </div>
                <?php
              }
            ?>
            </div>
            <p class="fw-bold text-center mt-2 sanpham_gia">
                <?php echo number_format($sp['gia_sp'], 0, ',', '.') . ' <sup>đ</sup>'  ?></p>
        </div>
        <?php
      }
    ?>
        ...
        <form action="<?php echo BASE_URL ?>hoi_dap/hoi_dap_insert" method="post">
            <div class="row">
                <div class="col-8">
                    ...
                    <button type="submit" class="btn btn-primary mt-3 float-end" style="background-color: #16511a;"> <i
                            class="fa-solid fa-paper-plane"></i>&ensp;Gửi</button>
                </div>
            </div>
        </form>
        <?php
    ...
    ?>
        ...
        foreach($data['hoi_dap_list'] as $key => $hd){
          if($hd['status'] == 0 && $hd['parent'] == 0){
            ?>
            <div style="font-weight: bold;">
                <i class="fa-solid fa-user-large" style="font-size: 20px; color:#FE8C23 ;"></i>&ensp;
                <?php echo $hd['ten_k'] ?>
            </div>
            <p class="mt-2"><?php echo $hd['noidung_hd'] ?></p>
            <p style="color: gray;"><i class="fa-solid fa-clock"></i> <span
                    style="color:gray ;"><?php echo $hd['thoigian_hd'] ?></span></p>
            <hr>
            <?php
          }
          foreach($data['hoi_dap_list1'] as $key => $hd1){
            ...
            <div class="alert alert-dark ms-5" role="alert">
                <i class="fa-solid fa-user-large" style="font-size: 20px; color:#E51F22 ;"></i>&ensp;
                <b><?php echo $hd1['ten_nv'] ?></b> <br>
                <?php echo $hd1['noidung_hd'] ?>
                <p style="color: blue;" class="mt-2"><i class="fa-solid fa-clock"></i> <span
                        style="color:gray ;"><?php echo $hd1['thoigian_hd'] ?></span></p>
            </div>
            <?php
            }
          }
